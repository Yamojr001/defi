...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-dark mb-4" style="border: 1px solid blue; border-radius: 15px;">
    <div class="container-fluid">
        ...
        <button class="navbar-toggler" style="background-color: #ffffff; color: black;" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="../admin/admin.php">Home</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="#">Staff Management</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="#">Approve Payment</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="#">View Scam Report</a>
                </li>
                <li class="nav-item">
